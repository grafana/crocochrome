...
Almost no business logic lives here. If you are looking for *what a session
does*, read [supervisor.md](supervisor.md); this page is about *how the process
starts and stops*.
...
### Why shut down the HTTP server *after* draining sessions
...
the cancellation that *triggered* shutdown does not also cancel the shutdown
work itself.
