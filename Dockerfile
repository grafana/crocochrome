FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v0.37.1@sha256:79092b373d4130035f1e0e70b27e951e6b3fa640c4a5da12fcf4ec6b818729e3 AS buildtools
WORKDIR /crocochrome
...
FROM ghcr.io/grafana/chromium-swiftshader-alpine:131.0.6778.264-r0-3.21.2@sha256:c3394ca2a5d82eecba8b8bceff972ca3f0f925ac9dec6cb24be8b84811f4f73f AS setcapper
...
FROM ghcr.io/grafana/chromium-swiftshader-alpine:131.0.6778.264-r0-3.21.2@sha256:c3394ca2a5d82eecba8b8bceff972ca3f0f925ac9dec6cb24be8b84811f4f73f
