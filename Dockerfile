FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.0.0@sha256:9275c9725ed864f69c216eab3d64a923bcc08ef97692a8a0ae0b170e18ec6696 AS buildtools
WORKDIR /crocochrome
