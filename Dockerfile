FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.33.0@sha256:549b023fb675564515a4dfe57ecee251e3c67b939f2bdbcce294a9472a54a2e6 AS buildtools
WORKDIR /crocochrome
