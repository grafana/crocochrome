FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.8.0@sha256:9ba63b0d884602c33787c1b067ca652433cf24c959b838291c6a3b365e3c96a0 AS buildtools
WORKDIR /crocochrome
