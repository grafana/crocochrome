FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.42.0@sha256:bc56136cd8768f0bd2eb3cb3811da61170b5f679c641bbb73e242aed4a064117 AS buildtools
WORKDIR /crocochrome
