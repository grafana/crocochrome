FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v0.37.0@sha256:64c6ff07fce6f93ba3732d4617b7ea3a370d7e87fd4e4cb92fd4faa25364cd50 AS buildtools
WORKDIR /crocochrome
