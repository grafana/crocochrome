FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v0.40.0@sha256:8676bdef66f7f39c216046613eb251c00af2b3181659d300f59d61a591cb9ddf AS buildtools
WORKDIR /crocochrome
