FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v0.39.1@sha256:ba874137e92fec42e24c97edc3736dd947c60dfd25882bb911add74f52fcef0d AS buildtools
WORKDIR /crocochrome
