FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.1.0@sha256:9935fc745d836b2be11f8c78a5f39b86ce6b629fc74d0b6af194145eea740800 AS buildtools
WORKDIR /crocochrome
