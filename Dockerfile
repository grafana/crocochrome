FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.4.0@sha256:a6892e46733388ee084d314db9413bfbb3bbc707934910f3a2d34051f07a9323 AS buildtools
WORKDIR /crocochrome
