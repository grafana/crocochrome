FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.5.5@sha256:3ce33a927f249b059ef931be305f4bb2605da978841ecb68986ce15c84b634cf AS buildtools
WORKDIR /crocochrome
