FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v0.38.0@sha256:6d83a5417e149ef3003500c23cc10629494cbe1e7e3c8fa5bd92510cdaa4c019 AS buildtools
WORKDIR /crocochrome
