FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:1.16.1@sha256:d44664a2a6115deb50d9663aa58f5addbabe605581f031d1522df83e7a8de180 AS buildtools
WORKDIR /crocochrome
