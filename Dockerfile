FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v0.40.2@sha256:81622249422614792ebc7ea082ba924f66efcc01a7070ad0138c241ac0c0e47a AS buildtools
WORKDIR /crocochrome
