FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.41.0@sha256:5d9716000ef2b72e8240f05baccc9ca76f40b69fb4c146250cdb8b221a28b650 AS buildtools
WORKDIR /crocochrome
