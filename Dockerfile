FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v0.38.1@sha256:41f2c06857e3e3283101c3179472509e09660a05054ae120d9831c1808799b18 AS buildtools
WORKDIR /crocochrome
