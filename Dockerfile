FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:v1.37.0@sha256:9258344db88ac23f4cfc7fee201a6c2c4f3ac72e056a5a6543fbae611807266c AS buildtools
WORKDIR /crocochrome
