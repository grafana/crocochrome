FROM --platform=$BUILDPLATFORM ghcr.io/grafana/grafana-build-tools:1.18.1@sha256:6630adad3acf6369ffd61b266a268c097ac312b3c1162f98eea09d7e5ade519b AS buildtools
WORKDIR /crocochrome
